  ...
  const sections = [
      ...
      content: (
        <div>
          <p className="mb-4">
            ...
            <a
              href="https://www.solverdeck.com/"
              className="underline text-white ml-1"
            >
              solverdeck
            </a>
            , features, content, applications, and products provided by
            Solverdeck Company.
          </p>
          <p className="mb-4">
            ...
            and abide by these Terms and our Privacy Policy, incorporated herein
            by reference. If you do not agree to these Terms, you must not
      ...
      content: (
        <div>
          <p className="mb-4">
            ...
            you meet the foregoing eligibility requirement. If you do not meet
            this requirement, you must not access or use the Services.
          </p>
        </div>
      ),
    },
    ...
    },
    {
      ...
      content: (
        <div>
          <p className="mb-4">
            We provide IT consulting and artificial intelligence (AI)
            integration services as described on our website and in any service
            agreement or statement of work agreed between you and us. Our
          ...
          <ul className="list-disc pl-6 mb-4">
            <li>
              We do not guarantee specific outcomes or results from the use of
              our Services.
            </li>
            <li>
              The performance of AI systems depends on various factors,
              including the quality and quantity of data provided.
            </li>
            <li>
              We cannot guarantee that AI systems will be free from errors,
              biases, or inaccuracies.
            </li>
            <li>
              Our Services are not intended for use in high-risk applications
              where failure could lead to death, personal injury, or severe
              environmental damage without additional safeguards and explicit
              agreements.
            </li>
          </ul>
        </div>
      ...
      content: (
        <div>
          ...
          <ul className="list-disc pl-6 mb-4">
            ...
            <li>
              Exploit the Services in any unauthorised way, including by
              automated means.
            </li>
            <li>
          ...
          <ul className="list-disc pl-6 mb-4">
            <li>
              We retain ownership of all AI models, algorithms, and systems
              developed or customised by us.
            </li>
            <li>
              You retain ownership of your data used to train or operate AI
              systems.
            </li>
            <li>
              You receive a license to use outputs generated by AI systems for
              your business purposes.
            </li>
            <li>
              We may use anonymised learnings from AI system development to
        ...
        <div>
          ...
          <ul className="list-disc pl-6 mb-4">
            ...
            <li>
              ...
              use or enjoyment of the Services, or which may harm the Company or
          ...
          <p className="mb-2">
            When using our Services, particularly AI integration services, you
            are responsible for:
          </p>
          <ul className="list-disc pl-6 mb-4">
            <li>
              Ensuring you have the right to use, process, and share any data
              provided to us.
            </li>
            <li>
            ...
            <li>
              Reviewing and validating outputs from AI systems before relying on
              them for business decisions.
            </li>
          </ul>
          <p className="mb-4">
            You are responsible for ensuring your use of the Services complies
            with all applicable laws and regulations, including but not limited
            to data protection, privacy, intellectual property, and export
            control laws.
          </p>
        </div>
      ),
    },
    {
      ...
      content: (
        <div>
          <p className="mb-2">
            You agree to pay all fees specified in the service agreement or
            statement of work. Except as otherwise specified:
          </p>
          <ul className="list-disc pl-6 mb-4">
            ...
            <li>
              Quantities purchased cannot be decreased during the relevant
              subscription term.
            </li>
          </ul>
          <p className="mb-2">
            Unless otherwise stated in the service agreement or statement of
            work:
          </p>
          <ul className="list-disc pl-6 mb-4">
            ...
            <li>
              We reserve the right to suspend or terminate the Services if fees
          ...
          <p className="mb-4">
            ...
            withholding taxes, assessable by any jurisdiction (collectively,
      ...
      content: (
        <div>
          <p className="mb-4">
            ...
            plans, technology and technical information, product designs, and
            business processes.
          </p>
          <p className="mb-2">The Receiving Party agrees to:</p>
          <ul className="list-disc pl-6 mb-4">
            <li>
              Take reasonable precautions to protect such Confidential
              Information.
            </li>
            <li>
              Not use any Confidential Information for any purpose outside the
      ...
      content: (
        <div>
          <p className="mb-4">
            ...
            and applicable data protection laws. Where we process personal data
            on your behalf, the terms of our Data Processing Agreement shall
            apply.
          </p>
          <p className="mb-4">
            We implement appropriate technical and organisational measures to
            protect personal data processed through our Services. However, no
            electronic transmission or storage of information can be entirely
            secure, and we cannot guarantee absolute security.
          </p>
          <p className="mb-2">
            When providing AI integration services, we will:
          </p>
          <ul className="list-disc pl-6 mb-4">
            <li>
              Implement appropriate safeguards for AI systems processing
              personal data.
            </li>
            <li>Provide information about how AI systems use personal data.</li>
            <li>
              Assist you in fulfilling your obligations under data protection
              laws.
            </li>
            <li>
              Implement measures to prevent discriminatory outcomes where
              possible.
            </li>
          </ul>
        </div>
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <ul className="list-disc pl-6 mb-4">
            <li>
              We do not guarantee that AI systems will be free from errors,
              biases, or inaccuracies.
            </li>
            <li>
              We do not warrant that AI systems will produce specific results or
              outcomes.
            </li>
            <li>
              We do not guarantee that AI systems will be suitable for any
              specific purpose.
            </li>
            <li>
              You acknowledge that AI systems may produce unexpected or
              unintended outputs.
            </li>
          </ul>
          <p className="mb-4">
            ...
            ON THE SERVICES; (iii) ANY CONTENT OBTAINED FROM THE SERVICES; OR
            (iv) UNAUTHORISED ACCESS, USE, OR ALTERATION OF YOUR TRANSMISSIONS
            OR CONTENT.
          </p>
          <p className="mb-4">
            OUR AGGREGATE LIABILITY ARISING OUT OF OR RELATED TO THESE TERMS OR
            THE SERVICES, WHETHER IN CONTRACT, TORT, OR UNDER ANY OTHER THEORY
            OF LIABILITY, SHALL NOT EXCEED THE TOTAL AMOUNT PAID BY YOU FOR THE
            SERVICES DURING THE 12 MONTHS PRECEDING THE EVENT GIVING RISE TO THE
            LIABILITY.
          </p>
          <p className="mb-2">
      ...
      content: (
        <div>
          <p className="mb-4">
            ...
            Services or maintain an account with us.
          </p>
      ...
      content: (
        <div>
          ...
          <p className="mb-4">
            ...
            transfer these Terms, at our sole discretion, without restriction.
          </p>
          <p className="mb-4">
          ...
          <p className="mb-4">
            ...
            constitute either of us as the agent of the other, or authorise
            either of us to make or enter into any commitments for or on behalf
            of the other.
          </p>
        </div>
      ),
        ...
        <div>
          ...
          <ul className="list-disc pl-6 mb-4">
            <li>
              Email:{" "}
              <a
                href="mailto:hello@solverdeck.com"
                className="underline text-white"
              >
                hello@solverdeck.com
              </a>
            </li>
            <li>Phone: (+44) 020 3836 3442</li>
            <li>Address: Hull, England</li>
          </ul>
        </div>
      ),
    },
            ...
            <div className="bg-neutral-900 p-6 rounded-lg shadow-md">
              ...
              <div className="mb-8 p-4 bg-neutral-800 rounded-lg border-l-4 border-gray-600">
                <p className="text-white">
                  These Terms of Service outline the rules and conditions for
                  using Solverdeck's products and services. Please review them
                  carefully.
                </p>
              </div>
              ...
              <div className="space-y-8">
                {sections.map((section) => (
                  ...
                  >
                    ...
                    <div
                      className={`mt-4 leading-relaxed ${activeSection === section.id ? "block" : "hidden"}`}
                    >
                      {section.content}
                    </div>
                  </section>
