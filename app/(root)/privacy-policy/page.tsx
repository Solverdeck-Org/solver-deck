  ...
  const sections = [
    {
      ...
      content: (
        <div>
          <p className="mb-4">
            Solverdeck ("we", "our", "us") is committed to protecting and
          ...
          <p className="mb-4">
            ...
            Commissioner’s Office (ICO) under registration number ZC000982, in
            accordance with the UK General Data Protection Regulation (UK GDPR)
            and the Data Protection Act 2018. We determine the purposes and means of processing your personal data.
          </p>
          <p className="mb-4">
      ...
      content: (
        <div>
          ...
          <ul className="list-disc pl-6 mb-4">
            ...
            <li className="mb-1">
              Contact Data: including billing address, delivery address, email
          ...
          <p className="mb-4">
            ...
            and public sources, such as analytics providers, advertising
            networks, search information providers, and business partners.
          </p>
          ...
          <p className="mb-4">
            If our AI systems process any special category data, we will do so
            only with your explicit consent or as otherwise permitted by law.
          </p>
        </div>
      ),
    },
    {
      ...
      content: (
        <div>
              ...
              <tbody>
                ...
                <tr>
                  <td className="border border-gray-700 px-4 py-2">
                    ...
                    you about changes to our terms or privacy policy (b) Asking
          ...
          <h4 className="font-semibold mt-4 mb-2">
            3.2 AI-Specific Processing:
          </h4>
          <p className="mb-4">
            When providing AI integration services, we may process your personal
            data to:
          </p>
          <ul className="list-disc pl-6 mb-4">
            <li className="mb-1">
              Train, test, or improve AI models (only with your explicit
              consent)
            </li>
            <li className="mb-1">Provide AI-powered analytics or insights</li>
            <li className="mb-1">
              Customise AI solutions to your specific needs
            </li>
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <ul className="list-disc pl-6 mb-4">
            <li className="mb-1">
              Service Providers: IT and system administration services, cloud
              service providers, payment processors, and other service providers
            ...
            <li className="mb-1">
              Business Partners: third parties with whom we partner to offer
    ...
    },
    {
      ...
      content: (
        <div>
          <p className="mb-4">
            We may transfer your personal data outside the UK to service
            providers, advisers, or business partners operating outside the UK.
          ...
          <ul className="list-disc pl-6 mb-4">
            <li className="mb-1">
              ...
              personal data by the UK government.
            </li>
            <li className="mb-1">
            ...
            <li className="mb-1">
              ...
              them if they are part of a framework that ensures they provide
              similar protection to personal data shared between the UK and the
              US.
            </li>
          </ul>
          <p className="mb-4">
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <p className="mb-4">
            If we use personal data to train or develop AI systems, we will:
          </p>
          <ul className="list-disc pl-6 mb-4">
          ...
          <p className="mb-4">
            Some of our services may involve automated decision-making,
            including profiling. Where this occurs:
          </p>
          <ul className="list-disc pl-6 mb-4">
            <li className="mb-1">
            ...
            <li className="mb-1">
              We will enable you to obtain human intervention, express your
          ...
          <p className="mb-4">
            We are committed to developing and using AI systems ethically. This
            includes:
          </p>
          <ul className="list-disc pl-6 mb-4">
            <li className="mb-1">
              Regularly testing for bias and discrimination
            </li>
            <li className="mb-1">
              Ensuring AI systems are explainable and transparent where possible
            </li>
            <li className="mb-1">Maintaining human oversight of AI systems</li>
            <li className="mb-1">
              Regularly reviewing and updating our AI governance framework
            </li>
          </ul>
        </div>
      ),
      ...
      content: (
        <div>
          ...
          <ul className="list-none mb-4">
            ...
            <li className="mb-1">
              • By phone:{" "}
              <a href="tel:+4402038363442" className="underline text-white">
                (+44) 020 3836 3442
              </a>
            </li>
          </ul>
            ...
            <div className="bg-neutral-900 p-6 rounded-lg shadow-md">
              ...
              <div className="mb-8 p-4 bg-neutral-800 rounded-lg border-l-4 border-gray-600">
                <p className="text-white">
                  This Privacy Policy outlines how Solverdeck collects, uses,
                  and protects your personal information. Please read it
