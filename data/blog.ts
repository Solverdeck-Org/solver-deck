export const blogs = [
  {
    slug: 'exploring-ai-in-business',
    title: 'Exploring the Power of AI in Modern Business',
    excerpt: 'Discover how artificial intelligence is revolutionizing various industries and providing new opportunities for growth and efficiency...',
    thumbnail: '/data3.jpg',
  },
  {
    slug: 'the-future-of-cloud-computing',
    title: 'The Future Landscape of Cloud Computing',
    excerpt: 'An in-depth look at the evolving trends and innovations shaping the future of cloud technology and its impact on businesses...',
    thumbnail: '/cloud-comp.jpg',
  },
  {
    slug: 'cybersecurity-best-practices',
    title: 'Essential Cybersecurity Best Practices for Your Organization',
    excerpt: 'Learn about the crucial steps and strategies to protect your business from ever-increasing cyber threats and ensure data security...',
